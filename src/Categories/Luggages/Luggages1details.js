...
import luggages1 from './img/luggages1.jpg'
import Bottombar from '../../Components/Bottombar'

function Luggages1details() {
    return (
        <React.Fragment>
            <Navbar/>
            <Secondadvertise
                brandName={<span style={{fontWeight: "Bold"}}>American Tourister Cruze<span style={{fontWeight: "400"}}> ABS 70cm/24inches Black Hardsided Suitcase</span></span>}
                visit="/Luggages1details"
...
export default Luggages1details
